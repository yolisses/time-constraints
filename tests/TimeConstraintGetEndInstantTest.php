...
class TimeConstraintGetEndInstantTest extends TestCase
{
    public function testGetEndInstant()
    {
        ...
        $time_constraint = new OrTimeConstraint([
            SinglePeriodTimeConstraint::fromStrings('2025-01-01 00:00', '2025-01-01 02:00'), // 2h
            SinglePeriodTimeConstraint::fromStrings('2025-01-02 01:00', '2025-01-02 03:00'), // 2h
            SinglePeriodTimeConstraint::fromStrings('2025-01-02 06:00', '2025-01-02 07:00'), // 1h 
            SinglePeriodTimeConstraint::fromStrings('2025-01-03 04:00', '2025-01-03 07:00'), // 3h
            SinglePeriodTimeConstraint::fromStrings('2025-01-04 04:00', '2025-01-04 06:00'), // 2h
        ]);
