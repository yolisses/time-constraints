...
class SingleDayTimeConstraintTest extends TestCase
{
    public function testGetPeriods()
    {
        ...
        $clamp_period = Period::fromDate('2025-01-01 02:03:04', '2025-01-03 05:06:07');

        $sequence = $constraint->getSequence($clamp_period);
    ...
    public function testGetPeriods2()
    {
        ...
        $clamp_period = Period::fromDate('2025-01-02 08:03:04', '2025-01-03 05:06:07');
